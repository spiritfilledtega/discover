! function() {
  ...
  function n(t) {
    r.href = t, r.host || (r.href = r.href);
    var e = r.host;
    r.pathname;
    return "http:" === r.protocol && (e = e.replace(/:80$/, "")), "https:" === r.protocol && (e = e.replace(/:443$/, "")), {
      host: e,
      pathname: ("/" === r.pathname[0] ? "" : "/") + r.pathname,
      href: r.href
    }
  }
  var o, a, s = {
  ...
  l.widgetId.get = function() {
    ...
    return []
  }, l.useWidgetHostForProduction.get = function() {
    return !1
    ...
    for (var e = n(t), i = e.host, r = e.href, o = document.getElementsByTagName("script"), a = [], s = 0; s < o.length; s++) {
      var c = o.item(s);
      c.src && n(c.src).href === r && a.push(c)
    }
    var h, l = (void 0 === (h = i) && (h = location.host), -1 !== ["i18n.tradingview.com", "partial.tradingview.com", "www.tradingview.com", "wwwcn.tradingview.com"].indexOf(h) || -1 !== ["d33t3vvu2t2yu5.cloudfront.net", "dwq4do82y8xi7.cloudfront.net", "s.tradingview.com", "s3.tradingview.com"].indexOf(h) || h.match(/^[a-z]{2}\.tradingview\.com/) || h.match(/prod-[^.]+.tradingview.com/) ? "battle" : h.includes("tradingview.com") || h.includes("staging") ? "staging" : h.match(/webcharts/) ? "staging_local" : (h.match(/^localhost(:\d+)?$/), "local"));
    ...
    var l, d = "32px",
      ...
      g = isNaN(this.settings.width) ? this.settings.width : this.settings.width + "px",
      u = this.script.parentNode.classList.contains("tradingview-widget-container");
    this.script.parentNode && u ? this.iframeContainer = this.script.parentNode : this.iframeContainer = document.createElement("div"), this.iframeContainer.style.width = g, this.iframeContainer.style.height = p, this.iframeContainer.appendChild(((l = document.createElement("style")).innerHTML = "\n\t.tradingview-widget-copyright {\n\t\tfont-size: 13px !important;\n\t\tline-height: 32px !important;\n\t\ttext-align: center !important;\n\t\tvertical-align: middle !important;\n\t\tfont-family: 'Trebuchet MS', Arial, sans-serif !important;\n\t\tcolor: " + i["color-gull-gray"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright .blue-text {\n\t\tcolor: " + i["color-brand"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a {\n\t\ttext-decoration: none !important;\n\t\tcolor: " + i["color-gull-gray"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:visited {\n\t\tcolor: " + i["color-gull-gray"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:hover .blue-text {\n\t\tcolor: " + i["color-scooter"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:active .blue-text {\n\t\tcolor: " + i["color-curious-blue"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:visited .blue-text {\n\t\tcolor: " + i["color-brand"] + " !important;\n\t}\n\t", l));
    var m = c && !this.settings.whitelabel,
      f = this.hasCopyright ? "calc(" + p + " - " + "32px)" : p;
    this.settings.utm_source = location.hostname, this.settings.utm_medium = h ? "widget_new" : "widget", this.settings.utm_campaign = this.widgetUtmName, this.iframe = this._createIframe(f, g, n, r, o.id);
    var w = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
    if (w ? (this.script.parentNode.replaceChild(this.iframe, w), this.script.parentNode.removeChild(this.script)) : u ? (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.removeChild(this.script)) : (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.replaceChild(this.iframeContainer, this.script)), function(t, e, i) {
      ...
      y.style.height = d, y.style.lineHeight = d, y.style.width = g, y.style.textAlign = "center", y.style.verticalAlign = "middle", y.innerHTML = c.innerHTML, this.iframeContainer.appendChild(y)
    }
  }, h.prototype._iframeSrcBase = function(t, e) {
    var i = "https://www.tradingview-widget.com",
      r = this.useWidgetHostForProduction ? i : "https://s.tradingview.com";
  ...
  }, h.prototype._createIframe = function(t, e, i, r, n) {
  ...
  new(function(t) {
    ...
    return function(t, i) {
    ...
    }(i, t), Object.defineProperty(i.prototype, "widgetId", {
      get: function() {
        return "ticker-tape"
      },
      enumerable: !1,
      ...
      var i, r, n, o, a, s, c, h = t.prototype.filterRawSettings.call(this, e);
      h.width = "100%";
      try {
        i = this.script.parentNode.getBoundingClientRect().width
      } finally {
        h.height = (r = e.displayMode, n = e.isTransparent, o = this.hasCopyright, a = i, c = r === d.Adaptive && a ? a <= g : r === d.Compact, s = c ? 72 : 44, n || (s += 2), o && (s += 32), s)
      }
      return h
